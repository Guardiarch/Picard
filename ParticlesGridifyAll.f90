...
! Parameters
  ...
  real*8, intent(out) :: F( species, 3, Nx_local+2, Ny_local+2, Nz_local+2 )
...
! Z BOUNDARY
  ...
  allocate( real_neg_send2(species,  3,  Nx_local+2,  Ny_local+2,  2) )
  allocate( real_pos_send2(species,  3,  Nx_local+2,  Ny_local+2,  2) )
  allocate( real_neg_recv2(species,  3,  Nx_local+2,  Ny_local+2,  2) )
  allocate( real_pos_recv2(species,  3,  Nx_local+2,  Ny_local+2,  2) )
  size_sendrecv2        = (species)*(3)*(Nx_local+2)*(Ny_local+2)*(2)
...
! Y BOUNDARY
  ...
  allocate( real_neg_send2(species,  3,  Nx_local+2,  2,  Nz_local+2) )
  allocate( real_pos_send2(species,  3,  Nx_local+2,  2,  Nz_local+2) )
  allocate( real_neg_recv2(species,  3,  Nx_local+2,  2,  Nz_local+2) )
  allocate( real_pos_recv2(species,  3,  Nx_local+2,  2,  Nz_local+2) )
  size_sendrecv2        = (species)*(3)*(Nx_local+2)*(2)*(Nz_local+2)
...
! X BOUNDARY
  ...
  allocate( real_neg_send2(species,  3,  2,  Ny_local+2,  Nz_local+2) )
  allocate( real_pos_send2(species,  3,  2,  Ny_local+2,  Nz_local+2) )
  allocate( real_neg_recv2(species,  3,  2,  Ny_local+2,  Nz_local+2) )
  allocate( real_pos_recv2(species,  3,  2,  Ny_local+2,  Nz_local+2) )
  size_sendrecv2        = (species)*(3)*(2)*(Ny_local+2)*(Nz_local+2)
